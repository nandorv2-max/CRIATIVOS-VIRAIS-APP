...
const CreativeEditorHeader: React.FC<CreativeEditorHeaderProps> = ({
         ...
         if (singleSelectedLayer.type === 'shape') {
            ...
            return (
                 <div className="flex items-center gap-3">
                    ...
                    {/* FIX: Corrected a typo from 'onUpdateLayers' to the correct prop name 'onUpdateSelectedLayers'. */}
    ...
    return (
        <header className="bg-brand-dark flex-shrink-0 p-3 flex items-center justify-between border-b border-brand-accent shadow-md z-30 gap-4">
            ...
            <div className="flex-1 flex justify-center items-center min-w-0 overflow-hidden">
                {showContextualTools && (
                     <div className="hidden md:flex items-center gap-2 overflow-x-auto p-1">
