...
const ErrorCard: React.FC<ErrorCardProps> = ({ era, isPolaroid = true, onRegenerate, showLabel = true }) => {
     const containerClass = isPolaroid ? `relative group bg-brand-polaroid p-3 pb-12 shadow-md` : 'pb-4 bg-brand-light rounded-xl shadow-md';
    const errorContainerClass = isPolaroid ? 'aspect-square bg-gray-200 border-2 border-dashed border-red-500/50' : 'rounded-t-xl bg-brand-dark border-2 border-dashed border-red-500/50 aspect-[3/4]';
