...
export const IconSparkles: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3L9.27 9.27L3 12l6.27 2.73L12 21l2.73-6.27L21 12l-6.27-2.73L12 3z" /></svg>
);
...
export const IconInstagram: React.FC<{className?: string}> = ({className}) => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="url(#instagram-gradient)" className={className}><defs><radialGradient id="instagram-gradient" cx="0.3" cy="1" r="1"><stop offset="0" stopColor="#FFD600"/><stop offset="0.1" stopColor="#FFD600"/><stop offset="0.5" stopColor="#FF6900"/><stop offset="1" stopColor="#D500C9"/></radialGradient></defs><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.85s-.012 3.584-.07 4.85c-.148 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07s-3.584-.012-4.85-.07c-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.85s.012-3.584.07-4.85c.149-3.227 1.664-4.771 4.919-4.919C8.416 2.175 8.796 2.163 12 2.163m0-1.001C8.729 1.162 8.316 1.173 7.053 1.23c-3.6.164-6.113 2.697-6.279 6.278-.057 1.263-.068 1.687-.068 4.848s.011 3.586.068 4.848c.166 3.581 2.679 6.115 6.279 6.279 1.264.057 1.688.068 4.948.068s3.684-.011 4.948-.068c3.599-.164 6.115-2.698 6.278-6.279.057-1.262.068-1.687.068-4.848s-.011-3.586-.068-4.848c-.163-3.581-2.679-6.115-6.278-6.278-1.264-.057-1.688-.068-4.948-.068zm0 5.838a5 5 0 100 10 5 5 0 000-10zm0 8.002a3 3 0 110-6 3 3 0 010 6zm4.965-8.243a1.2 1.2 0 100 2.4 1.2 1.2 0 000-2.4z"/></svg>;
