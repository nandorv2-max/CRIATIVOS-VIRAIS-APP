...
const LoadingCard: React.FC<LoadingCardProps> = ({ isPolaroid = true, showLabel = true }) => {
    const containerClass = isPolaroid ? 'relative bg-gray-100 p-3 pb-12 shadow-md' : 'pb-4 bg-gray-900 rounded-xl shadow-md';
    ...
    return (
        <div className={containerClass}>
            ...
            <div className="absolute inset-0 flex items-center justify-center"><div className="animate-spin rounded-full h-10 w-10 border-t-2 border-b-2 border-yellow-400"></div></div>
        </div>
    );
};
