        ...
        <div className="min-h-screen flex items-center justify-center p-4">
            ...
            >
                <header className="my-12 flex flex-col items-center">
                    ...
                    <p className="mt-4 text-lg text-gray-300">Transforme as suas fotos com o poder da IA do Gemini.</p>
                </header>
                ...
                <main className="mt-8 space-y-6">
                 ...
                 <footer className="absolute bottom-5 left-1/2 -translate-x-1/2 text-xs text-gray-400">
                    Feito com Gemini
                </footer>
            </motion.div>
        </div>
