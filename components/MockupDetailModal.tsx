    ...
    return (
        <>
            ...
            <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4">
                <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="bg-brand-dark rounded-2xl p-6 border border-brand-accent shadow-2xl w-full max-w-4xl relative flex flex-col md:flex-row gap-6 h-[90vh] overflow-y-auto">
                    {/* Controls Panel */}
                    <div className="w-full md:w-1/2 flex flex-col gap-4 flex-shrink-0">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <div onClick={() => setIsUploadOptionsModalOpen(true)} className="cursor-pointer aspect-square md:aspect-video w-full bg-brand-light border-2 border-dashed border-brand-accent rounded-lg flex items-center justify-center text-center text-gray-400 hover:border-brand-primary">
                    ...
                    {/* Result Panel */}
                    <div className="w-full md:w-1/2 bg-black rounded-lg flex flex-col items-center justify-center p-2 flex-grow min-h-[300px]">
